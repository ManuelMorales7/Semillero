...
// const sortedNameInventoros = inventors.sort((a,b) => {
//   if(a.first_name < b.first_name)
//   return -1;
// });

// const mappedInvestorsName = inventors.map(inventor =>{
//   return{
//     name: inventor.first_name + " " + inventor.last_name,
//     gender: inventor.gender
//   }
// })

// const reducedInventorsAge = inventors.reduce((acumulado, actual)=>{
//   return acumulado + actual.birth_date;
// });

years = [];
inventors.forEach(inventor => {
  years.push(2021- inventor.birth_date)
});


const menorAMayor = years.sort((a,b) => {
...
// console.table(sortedNameInventoros);
// console.table(reducedInventorsAge);